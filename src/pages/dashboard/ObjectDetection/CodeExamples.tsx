...
url = "https://api.dolbo.ai/v1/detect/objects"
...
const response = await fetch('https://api.dolbo.ai/v1/detect/objects', {
  method: 'POST',
  headers: {
...
console.log(result);`,
  ...
  curl: `curl -X POST https://api.dolbo.ai/v1/detect/objects \\
